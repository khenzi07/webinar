INSERT INTO POST_MODEL (id, body, title, user_id) VALUES
  (1, 'Hamlet', 'Neither a borrower nor a lender be; for loan oft loses both itself and friend.', 1),
  (2, 'A Midsummer Nights Dream', 'Love looks not with the eyes, but with the mind, and therefore is winged Cupid painted blind', 2),
